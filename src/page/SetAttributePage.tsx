import { Dispatch, FormEventHandler, MouseEventHandler, SetStateAction, useCallback, useEffect, useState, useRef } from 'react';
...
import { PanelTrainValType } from './type';
...
const SetAttributePage = (props: SetAttributePagePageProps) => {
    ...
    const onDragEnd = (event: any) => {
        ...
        if (selectedList.includes(removeItem.image_uuid)) {
            selectedList.forEach(function (myItem, myIndex) {
                ...
                // const moveItem = find(newPanelDataset, prop => (prop.image_uuid)? === myItem);


                console.log('---------------------')
                console.log(newPanelDataset['train']?.['PASS'] || [])
            ...
            console.log('not on selected list');
    ...
    const handleShiftSelect=(myIndex:number,myStr1:string,myStr2:string)=>{
        ...
        console.log('handleShiftSelect',myIndex,myStr1,myStr2)
                                        ...
                                        <div className="train-val-container">
                                            <div className="train-val-wrapper">
                                                ...
                                                <div className="pass-ng-container">
                                                    <div className={trainNum < 2 ? 'pass-ng-wrapper-warn' : 'pass-ng-wrapper'} onClick={() => dispatch(setToggleArea(1))} onDoubleClick={() => handleAreaSelectAll(1)} style={{ backgroundColor: (selectedArea === 1) ? '#D9FFFF' : '#FFFFFF' }}>
                                                    ...
                                                    <div className={trainNum < 2 ? 'pass-ng-wrapper-warn' : 'pass-ng-wrapper'} onClick={() => dispatch(setToggleArea(2))} onDoubleClick={() => handleAreaSelectAll(2)}  style={{ backgroundColor: (selectedArea === 2) ? '#D9FFFF' : '#FFFFFF' }}>
                                            ...
                                            <div className="train-val-wrapper">
                                                ...
                                                <div className="pass-ng-container">
                                                    <div className={valNum < 1 ? 'pass-ng-wrapper-warn' : 'pass-ng-wrapper'} onClick={() => dispatch(setToggleArea(3))} onDoubleClick={() => handleAreaSelectAll(3)}  style={{ backgroundColor: (selectedArea === 3) ? '#D9FFFF' : '#FFFFFF' }}>
                                                    ...
                                                    <div className={valNum < 1 ? 'pass-ng-wrapper-warn' : 'pass-ng-wrapper'} onClick={() => dispatch(setToggleArea(4))} onDoubleClick={() => handleAreaSelectAll(4)}  style={{ backgroundColor: (selectedArea === 4) ? '#D9FFFF' : '#FFFFFF' }}>
                                                ...
                                                <Droppable droppableId="train_GOLDEN">
                                                    {(provided) => (
                                                        <div
                                                            ...
                                                            onDoubleClick={() => handleAreaSelectAll(5)}
                                                            onClick={() => dispatch(setToggleArea(5))} style={{ backgroundColor: (selectedArea === 5) ? '#D9FFFF' : '#FFFFFF' }}
                                                        >
                                                ...
                                                <Droppable droppableId="train_DELETE">
                                                    {(provided) => (
                                                        <div ref={provided.innerRef} {...provided.droppableProps} className="img-container-shadow" 
                                                            onDoubleClick={() => handleAreaSelectAll(6)}
                                                            onClick={() => dispatch(setToggleArea(6))} style={{ backgroundColor: (selectedArea === 6) ? '#D9FFFF' : '#FFFFFF' }}>
