...
const ServerPage = (props) => {
    ...
    const getServerStatus_xx = (myServerList) => {
    ...
    const handleSaveItem = async() => {
        ...
        if (currentEditIndex >= 0) {
            ...
            const newServerList = serverList.concat({ name: serverNameRef.current.getInputValue(), ip: serverIpRef.current.getInputValue(), port: serverPortRef.current.getInputValue(), online: true });
            setServerList(newServerList);
