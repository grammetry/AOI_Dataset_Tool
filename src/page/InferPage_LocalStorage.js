...
const InferPage = (props) => {
    ...
    const xmlTableColumnWidth = ['5%', '15%', '10%', '10%', '50%', '10%'];
    ...
    const getDelayTime_1 = (myCreateTime, myDetailData) => {
        ...
        if (myIndex1 >= 0) {
            ...
            const myTime1 = Math.round(myCreateTime);
            const myTime2 = moment(myDetailData.substring(myIndex1 + 14, myIndex1 + 33)).unix() + 28800;
            const myDelayTime = myTime1 - myTime2;

            return myTime1 - myTime2 + 's';
        } else {
            return 'N/A';
    ...
    const getDelayTime_2 = (myCreateTime, myDetailData) => {
        ...
        if (myIndex2 >= 0) {
            AoiTime = moment(myDetailData.substring(myIndex2 + 1, myIndex2 + 15), 'YYYYMMDDHHmmss').unix();
        }
    ...
    const handleQuery = async () => {
        ...
        myUrl += `?start_time=${startTime}&end_time=${endTime}`;
    ...
    const handelXmlDetail = (myBoardSn) => {
    ...
    const handelLogTypeChange = (item) => {
    ...
    useEffect(() => {
        ...
        // if (myCurrentServer) {
        //     if (myCurrentServer.length > 0) {
        //         setCurrentServer(myCurrentServer);
        //         getTaskList(myCurrentServer);
        //         getModelList(myCurrentServer);
        //         if (theOption) {
        //             serverSelectorRef.current.setValue(theOption);
        //         }
        //         return;
        ...
        //         serverSelectorRef.current.setValue(myOptionList[0]);
        //         setCurrentServer(`${myList[0].ip}:${myList[0].port}`);
        //         getTaskList(`${myList[0].ip}:${myList[0].port}`);
        //     }
                                            ...
                                            <div>
                                                <div className='row'>
                                                    <div className='col-md-3 p-3'>
                                                        ...
                                                        <div>
                                                            <ServerSelector defaultValue={logTypeOption[0]} options={logTypeOption} onChange={handelLogTypeChange} ref={logTypeSelectorRef} />
                                                        </div>
                                                    </div>
                                                    <div className='col-md-3 p-3'>
                                                        <div className='my-input-title py-1'>
                                                        ...
                                                        <div >
                                                            <CustomDatePicker width="100%" ref={fromDateRef}></CustomDatePicker>
                                                    ...
                                                    <div className='col-md-3 p-3'>
                                                        ...
                                                        <div>
                                                            <CustomDatePicker width="100%" ref={toDateRef}></CustomDatePicker>
                                                        </div>
                                                    </div>
                                                                                ...
                                                                                queryList.map((item, i) => (
                                                                                    ...
                                                                                    <div key={`serverList_${i}`} >
                                                                                        ...
                                                                                        <div className={(i === (serverList.length - 1)) ? `my-tbody-row-${(i % 2 === 1) ? "1" : "2"} flash-element` : `my-tbody-row-${(i % 2 === 1) ? "1" : "2"}`} task_uuid={item.tao_model_uuid} onClick={() => console.log('click')}>
                                                                                            ...
                                                                                            <div className='my-tbody-td' style={{ width: currentTableColumnWidth[4], }}>{item.details.details_msg}</div>
                                                                                    ...
                                                                                    <div key={`serverList_${i}`} >
                                                                                        ...
                                                                                        <div className={(i === (serverList.length - 1)) ? `my-tbody-row-${(i % 2 === 1) ? "1" : "2"} flash-element` : `my-tbody-row-${(i % 2 === 1) ? "1" : "2"}`} task_uuid={item.tao_model_uuid} onClick={() => console.log('click')}>
                                                                                            ...
                                                                                            <div className='my-tbody-td' style={{ width: xmlTableColumnWidth[5], }}>
                                                                                                <CustomButton name="general" text="Detail" width={100} height={32} onClick={() => handelXmlDetail(item.board_sn)}></CustomButton>
                                                                                            </div>
